...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    secondary: "bg-neutral-800 hover:bg-neutral-700 text-neutral-200 border border-neutral-700 focus:ring-neutral-500",
    danger: "bg-red-600 hover:bg-red-700 text-white focus:ring-red-500",
    ghost: "text-neutral-400 hover:text-neutral-200 hover:bg-neutral-800 focus:ring-neutral-500",
  };
